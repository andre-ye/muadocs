...
layout: Post
content-type: static
permalink: /med_grp/b/annotate
title: Min/Max Protocol
---
...
You will annotate 40 images using the **min/max protocol**. In this method, you will draw
...
## [6] Experience Survey
After you are finished annotating, please fill out this quick second-half [experience form](https://docs.google.com/forms/d/e/1FAIpQLSfaITnO9Jn5mQr67Wk5tqDRryEHpU_oLSO0NtrJyXWPU1tT6A/viewform?usp=sf_link){:target="_blank"}.

## [7] Finished?

Congradulations! You're halfway done. [Let's Go →](/muadocs/med_grp/b/annotate2)
